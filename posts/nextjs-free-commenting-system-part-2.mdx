...
<Link passHref href="/blog/nextjs-free-commenting-system-part-1"><a>In the previous article</a></Link> we built the basic interface for our commenting system. Now we need to program the API endpoints to communicate with Github's API in order to save and retrieve the comments.
...
Full Series:
- 1/2 <Link passHref href="/blog/nextjs-free-commenting-system-part-1"><a>NextJS Free Commenting System using Github Part 1</a></Link>
- 2/2 <Link passHref href="/blog/nextjs-free-commenting-system-part-2"><a>NextJS Free Commenting System using Github Part 2</a></Link>