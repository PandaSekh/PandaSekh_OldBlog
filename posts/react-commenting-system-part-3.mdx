...
>
    <video preload="true" autoPlay loop muted playsInline>
        <source src="/image/react-commenting/reactions-example.gif" type="video/gif" />
        <source src="/image/react-commenting/reactions-example.mp4" type="video/mp4" />
    </video>
</div>
...
![The Emoji Reaction Block](/image/react-commenting/emoji-block.jpg)
...
![The Different Emojis](/image/react-commenting/difference.png)
