export default function GitHub() {
  return (
    ...
    <svg aria-label="GitHub" role="img" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 group"> 
      <rect width="512" height="512" rx="15%" fill="#a2a2a2" className="group-hover:fill-current text-github"/>
